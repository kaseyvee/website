  ...
  return (
    <section id="contact" className="page">
      ...
      <Tooltip title="GitHub">
        <a href="https://github.com/kaseyvee" target="_blank" rel="noreferrer noopener"><i className="fa-brands fa-github"></i></a>
      </Tooltip>
      <Tooltip title="LinkedIn">
        <a href="https://www.linkedin.com/in/kasey-valdez/" target="_blank" rel="noreferrer noopener"><i className="fa-brands fa-linkedin"></i></a>
      </Tooltip>
